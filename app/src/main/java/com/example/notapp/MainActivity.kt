...
import com.example.notapp.Adapter.NotesAdapter
import com.example.notapp.Database.NoteDatabase
import com.example.notapp.Models.Note
import com.example.notapp.Models.NoteViewModel
import com.example.notapp.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity(),NotesAdapter.NotesClickListener, PopupMenu.OnMenuItemClickListener {

    private lateinit var binding: ActivityMainBinding
    private lateinit var databse: NoteDatabase
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databse = NoteDatabase.getDatabase(this)
    }
